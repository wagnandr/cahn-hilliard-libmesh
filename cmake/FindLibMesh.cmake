...
list(APPEND PC_LIBMESH_LIBRARIES ${LIBMESH_DIR}/lib/libtimpi_${METHOD}.so)
...
find_library(LIBMESH_LIBRARY
  NAMES mesh_${METHOD} libmesh timpi
...
list(APPEND LIBMESH_LIBRARIES ${LIBMESH_DIR}/lib/libtimpi_${METHOD}.so)
